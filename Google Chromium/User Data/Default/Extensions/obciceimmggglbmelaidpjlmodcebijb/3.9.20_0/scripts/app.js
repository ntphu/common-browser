...
BH.Templates['app.html'] = '<div class=\"frame\"><div class=\"mainview view\"></div><div class=\"navigation\"><h1><a href=\"#/\">{{i18n_history_title}}</a></h1><div class=\"available_tags\"></div></div></div>';
BH.Templates['credits.html'] = '<img class=\"logo\" src=\"/images/logo.png\"><h1 class=\"title\">{{i18n_credits_title}}</h1><div class=\"content-area\"><h3>Open source frameworks in use</h3><ul class=\"open_source\"><li><a href=\"http://backbonejs.org/\">Backbone</a></li><li><a href=\"http://documentcloud.github.com/underscore/\">Underscore</a></li><li><a href=\"http://zeptojs.com/\">Zepto</a></li><li><a href=\"https://github.com/janl/mustache.js/\">Mustache.js</a></li><li><a href=\"http://momentjs.com/\">Moment.js</a></li><li><a href=\"https://github.com/roykolak/chrome-bootstrap\">Chrome Bootstrap</a></li><li><a href=\"https://github.com/roykolak/chrome-historian\">Chrome Historian</a></li></ul><h3>{{i18n_translators_heading}}</h3><div><ul class=\"translators\"><li><a href=\"http://twitter.com/laucmar\">Laura Mart\xEDnez</a><div class=\"language\">{{i18n_spanish}}</div></li><li><a href=\"http://gplus.to/dfakhriev\">Damir Fakhriev</a><div class=\"language\">{{i18n_russian}}</div></li><li><a href=\"https://plus.google.com/115314774787477379472\">Filipe Catal\xE3o</a><div class=\"language\">{{i18n_portuguese}}</div></li><li><a href=\"http://theopenspring.com\">Gianluca Sangiovanni</a><div class=\"language\">{{i18n_italian}}</div></li><li><a href=\"mailto:tebai.hamza@gmail.com\">Hamza Tebai</a><div class=\"language\">{{i18n_french}}</div></li><li><a href=\"http://about.me/henrikcederblad\">Henrik Cederblad</a><div class=\"language\">{{i18n_swedish}}</div></li><li><a href=\"https://plus.google.com/u/0/115959812130668207635/posts\">PBB</a><div class=\"language\">{{i18n_chinese_simplified}}</div></li></ul><ul class=\"translators\"><li><a href=\"http://twitter.com/kurtextrem\">Jacob G</a><div class=\"language\">{{i18n_german}}</div></li><li><a href=\"http://www.jedlikowski.com\">Przemek Jedlikowski</a><div class=\"language\">{{i18n_polish}}</div></li><li><a href=\"https://twitter.com/yl_ksa\">Wael M. Hazzazi</a><div class=\"language\">{{i18n_arabic}}</div></li><li><a href=\"http://twitter.com/HowManyFiles\">\u30CF\u30A6\u30E1\u30CB</a><div class=\"language\">{{i18n_japanese}}</div></li><li><a href=\"http://facebook.com/khaister\">Khai Nguyen</a><div class=\"language\">{{i18n_vietnamese}}</div></li><li>Juanjo Teruel<div class=\"language\">{{i18n_catalonian}}</div></li></ul></div></div><div class=\"action-area\"><div class=\"action-area-right\"><div class=\"button-strip\"><button class=\"button close\">{{i18n_close_button}}</button></div></div></div>';
BH.Templates['devices.html'] = '<header><h1>{{i18n_devices_title}}</h1><div class=\"corner\"><input class=\"search\" placeholder=\"{{i18n_search_input_placeholder_text}}\" tabindex=\"1\" type=\"text\"></div></header><div class=\"content\"></div>';
BH.Templates['devices_list.html'] = '<div class=\"controls\">{{#availableDevices}}<ol class=\"pagination {{paginationClass}}\">{{#devices}}<li><a href=\"#\" data-name=\"{{name}}\" style=\"padding: 0 10px; width: auto;\">{{name}}</a></li>{{/devices}}</ol>{{/availableDevices}} {{^availableDevices}} <span class=\"match\" style=\"padding: 2px 5px\">No active device sessions found</span> {{/availableDevices}}<div class=\"spacer\"></div><span class=\"text\">(Updated every few minutes)</span></div>';
BH.Templates['devices_results.html'] = '{{#sessions}}<ol class=\"visits highlightable editable\">{{#sites}}<li class=\"visit\" data-url=\"{{url}}\" data-title=\"{{title}}\"><a href=\"{{url}}\" class=\"item site\"><dl class=\"description\" style=\"background-image: url(chrome://favicon/{{url}})\"><dt><div class=\"active_tags\"></div>{{{title}}}</dt><dd class=\"location\">{{url}}</dd></dl></a> <a class=\"search_domain action\" href=\"#search/{{host}}\">{{i18n_search_by_domain}}</a></li>{{/sites}}</ol>{{/sessions}}';
BH.Templates['mailing_list.html'] = '<img class=\"logo\" src=\"/images/logo.png\"><h1 class=\"title\">{{i18n_mailing_list_title}}</h1><div class=\"content-area\"><p>{{i18n_mailing_list_description}}</p><a href=\"http://mad.ly/signups/84938/join\" target=\"_blank\" id=\"join_mailing_list\">{{i18n_mailing_list_link}}</a><p><i>{{i18n_mailing_list_promise}}</i></p></div><div class=\"action-area\"><a href=\"https://chrome.google.com/webstore/detail/better-history/obciceimmggglbmelaidpjlmodcebijb/reviews\" target=\"_blank\">{{i18n_leave_a_review}}</a><div class=\"action-area-right\"><div class=\"button-strip\"><button class=\"button close\">{{i18n_close_button}}</button></div></div></div>';
BH.Templates['menu.html'] = '<ul class=\"menu\"><li><a href=\"#visits\" class=\"visits\">Activity</a></li><li><a href=\"#devices\" class=\"devices\">{{i18n_devices_link}}</a></li><li><a href=\"#search\" class=\"search\">Search</a></li><li><a href=\"#statistic\" class=\"statistic\">Statistic</a></li></ul><ul class=\"menu\"><li><a class=\"setting\" href=\"#settings\">{{i18n_settings_link}}</a></li></ul>';
BH.Templates['modal.html'] = '<div class=\"overlay transparent\" id=\"overlay\"><div class=\"page\"></div></div>';
BH.Templates['prompt.html'] = '<div class=\"spinner\"></div><h1 class=\"title\">{{i18n_prompt_title}}</h1><div class=\"content-area\">{{{content}}}</div><div class=\"action-area\"><div class=\"action-area-right\"><div class=\"button-strip\"><button class=\"no\">{{i18n_prompt_cancel_button}}</button> <button class=\"yes\">{{i18n_prompt_delete_button}}</button></div></div></div>';
BH.Templates['search.html'] = '<header><h1><span class=\"title\">{{title}}</span></h1><div class=\"corner\"><input class=\"search\" placeholder=\"{{i18n_search_input_placeholder_text}}\" tabindex=\"1\" type=\"text\"></div><div class=\"search_controls\"></div></header><div class=\"fade\"></div><div class=\"cached\" style=\"display: none\">Showing results from <span class=\"datetime\">DATE</span>. <a class=\"fresh_search\">Freshen search</a></div><div class=\"content\"><div class=\"visits_content\"></div></div>';
BH.Templates['search_controls.html'] = '<div class=\"controls\">{{^query}} <span class=\"text search_hint\">Pssst... try searching for something</span> {{/query}}<div class=\"spinner\"></div><div class=\"pagination\" style=\"margin: 0; position: relative;\"></div><div class=\"spacer\"></div><a href=\"#\" id=\"search_tips\" style=\"margin-right: 20px;\">Search tips</a> <button class=\"delete_all\" disabled>{{i18n_delete_all_visits_for_search_button}}</button></div>';
BH.Templates['search_pagination.html'] = '<ol class=\"pagination {{paginationClass}}\">{{#pages}}<li><a href=\"{{url}}\" data-page=\"{{number}}\" class=\"{{className}}\">{{number}}</a></li>{{/pages}}</ol><div class=\"number_of_visits\">{{i18n_number_of_visits}}</div>';
BH.Templates['search_results.html'] = '<ol class=\"visits highlightable editable\">{{#visits}} {{#filename}}<li class=\"visit visit_view\" data-url=\"{{url}}\"><a href=\"{{url}}\" class=\"item download\" data-download-id=\"{{id}}\"><dl class=\"description\" style=\"background-image: url(chrome://favicon/{{url}})\"><dt>{{{name}}} ({{size}} MB)</dt><dd class=\"location\">{{{location}}}</dd><dd class=\"datetime\">{{{time}}}</dd></dl></a> <a class=\"delete_download delete\" href=\"#\" data-url=\"{{url}}\" title=\"{{i18n_prompt_delete_button}}\">{{i18n_prompt_delete_button}}</a></li>{{/filename}} {{^filename}}<li class=\"visit visit_view searched\" data-url=\"{{url}}\" data-title=\"{{title}}\"><a href=\"{{url}}\" class=\"site\"><dl class=\"description\" style=\"background-image: url(chrome://favicon/{{url}})\"><dt><div class=\"active_tags\"></div>{{{name}}}</dt><dd class=\"location\">{{{location}}}</dd><dd class=\"datetime\">{{{datetime}}}</dd></dl></a> <a class=\"delete_visit delete\" href=\"#\" data-url=\"{{url}}\" title=\"{{i18n_prompt_delete_button}}\">{{i18n_prompt_delete_button}}</a></li>{{/filename}} {{/visits}} {{#extendSearch}}<li class=\"search_deeper\"><div class=\"wrapper\"><div class=\"search_controls\"><br><button class=\"search_deeper\">Search deeper</button> <strong>(can be a bit slow)</strong></div><div class=\"working\"><br><strong>Searching deeper...</strong></div></div></li>{{/extendSearch}}</ol>{{^visits}}<p class=\"no_visits\">{{i18n_no_visits_found}}</p>{{/visits}}';
BH.Templates['search_tips.html'] = '<img class=\"logo\" src=\"/images/logo.png\"><h1 class=\"title\">{{i18n_search_tips_title}}</h1><div class=\"content-area\"><p><strong>Regular expression searching is now supported!</strong><br><br>For example, try searching for <a href=\"#search//^Inbox/\">/^Inbox/</a> or <a href=\"#search//News|Info/\">/News|Info/</a></p><p style=\"margin-top: 20px\"><strong>Search for visits and downloads</strong><br><br>Searching will automatically look for visits, by page title and url, and downloads, by filename and url.</p><p style=\"margin-top: 20px\"><strong>Search deeper</strong><br><br>Your last 10,000 visits are used for a fast, initial search. To search deeper, visit the bottom of the last page of results and click the Search deeper button.</p></div><div class=\"action-area\"><a href=\"mailto:betterhistoryextension@gmail.com\" target=\"_blank\">{{i18n_search_suggestion_link}}</a><div class=\"action-area-right\"><div class=\"button-strip\"><button class=\"button close\">{{i18n_close_button}}</button></div></div></div>';
BH.Templates['settings.html'] = '<header><h1>{{i18n_settings_title}}</h1></header><div class=\"content\"><div class=\"settings\"><section><h3>{{i18n_clearing_history_section_title}}</h3><div><button class=\"clear_history\">{{i18n_clear_history_button}}</button></div></section><section><h3>{{i18n_right_click_options_section_title}}</h3><div class=\"checkbox\"><label><input id=\"search_by_selection\" type=\"checkbox\"> <span>{{i18n_search_by_text_selection_label}}</span></label></div><div class=\"checkbox\"><label><input id=\"search_by_domain\" type=\"checkbox\"> <span>{{i18n_search_by_domain_label}}</span></label></div><div class=\"checkbox\"><label><input id=\"use_24_hour_clock\" type=\"checkbox\"> <span>{{i18n_use_24_hour_clock_label}}</span></label></div></section><section><h3>{{i18n_whats_new_section_title}}</h3><div><div class=\"row\"><a class=\"modal_link credits\" href=\"#settings/credits\">{{{i18n_credits_link}}}</a></div></div></section><section><h3>{{i18n_feedback_section_title}}</h3><div>{{{i18n_suggestions_bugs_comments}}}<br><a style=\"margin-top: 10px; display: block;\" href=\"mailto:betterhistoryextension@gmail.com\">betterhistoryextension@gmail.com</a></div></section><section><h3>{{i18n_spread_the_word_section_title}}</h3><div><div class=\"row\"><a href=\"https://chrome.google.com/webstore/detail/obciceimmggglbmelaidpjlmodcebijb/reviews\">{{i18n_leave_a_review}}</a></div><div class=\"row\"><a class=\"twitter-follow-button\" data-lang=\"{{i18n_twitter_language}}\" data-show-count=\"false\" data-width=\"150px\" href=\"https://twitter.com/better_history\">Follow @better_history</a> <a class=\"twitter-share-button\" data-count=\"horizontal\" data-lang=\"{{i18n_twitter_language}}\" data-text=\"{{i18n_twitter_template}}\" data-url=\"https://chrome.google.com/webstore/detail/obciceimmggglbmelaidpjlmodcebijb\" data-via=\"Better_History\" href=\"https://twitter.com/share\">Tweet</a></div></div></section></div></div>';
BH.Templates['statistic.html'] = '<header><h1>Statistic</h1></header><div class=\"content\"><div id=\"nav\"><a id=\"today\">Today</a> &nbsp;|&nbsp; <a id=\"yesterday\">Yesterday</a> &nbsp;|&nbsp; <a id=\"thisweek\">This Week</a> &nbsp;|&nbsp; <a id=\"prevweek\">Previous Week</a> &nbsp;|&nbsp; <a id=\"average\">Average</a> &nbsp;|&nbsp; <a id=\"all\">All Time</a></div><div style=\"clear:both\"></div><div id=\"data\"><span id=\"nodata\">Start browsing to collect usage data.</span><div id=\"chart_div\"></div><div id=\"table_div\"></div></div></div>';
BH.Templates['timeline.html'] = '<ol class=\"pagination control today\" style=\"display:none;\"><li><a href=\"#visits/today\" title=\"Back to today\"><div class=\"arrow\">&laquo;&laquo;</div></a></li></ol><ol class=\"pagination next_control control\"><li><a href=\"#\" class=\"next {{#nextButtonDisabled}}disabled{{/nextButtonDisabled}}\"><div class=\"arrow\">&laquo;</div></a></li></ol><ol class=\"pagination\">{{#dates}}<li><a class=\"{{#selected}}selected{{/selected}} date\" href=\"#visits/{{id}}\"><strong>{{label}}</strong> <span class=\"date\">{{date}}</span></a></li>{{/dates}}</ol><ol class=\"pagination previous_control control\"><li><a href=\"#\" class=\"previous\"><div class=\"arrow\">&raquo;</div></a></li></ol>';
BH.Templates['visit.html'] = '<li class=\"visit visit_view searched\" data-url=\"{{url}}\" data-title=\"{{title}}\"><a href=\"{{url}}\" class=\"site\"><dl class=\"description\" style=\"background-image: url(chrome://favicon/{{url}})\"><dt><div class=\"active_tags\"></div>{{{title}}}</dt><dd class=\"location\">{{{url}}}</dd><dd class=\"datetime\"></dd></dl></a> <a class=\"delete_visit delete\" href=\"#\" data-url=\"{{url}}\" title=\"{{i18n_prompt_delete_button}}\">{{i18n_prompt_delete_button}}</a></li>';
BH.Templates['visits.html'] = '<header style=\"background: #FFF\"><h1>Activity</h1><div class=\"corner\"><input class=\"search\" placeholder=\"{{i18n_search_input_placeholder_text}}\" tabindex=\"1\" type=\"text\"></div><div class=\"controls\" style=\"border-bottom: none;\"><div class=\"timeline_view\"></div></div></header><div class=\"content\"><div class=\"visits_content\"></div></div>';
BH.Templates['visits_results.html'] = '{{#history}}<div class=\"controls hours\"><div class=\"moon\"></div><ol class=\"pagination\">{{#hours}}<li><a href=\"#hour_{{value}}\" data-hour=\"{{value}}\" class=\"{{^enabled}}disabled{{/enabled}}\">{{label}}</a></li>{{/hours}}</ol><div class=\"sun\"></div></div><div>{{#visitsByHour}}<div id=\"hour_{{hour}}\" class=\"hour_visits\" data-hour=\"{{hour}}\" style=\"padding-top: 10px;\"><div class=\"controls\" style=\"border: none;\"><h4 style=\"margin: 10px 0 0;\"><strong>{{hour_label}}</strong></h4><div class=\"spacer\"></div><button class=\"delete_hour\" style=\"font-size: 11px;\" data-hour=\"{{hour}}\">{{i18n_delete_all_visits_for_filter_button}}</button></div><ol class=\"visits highlightable editable\">{{#visits}} {{#filename}}<li class=\"visit\" data-url=\"{{url}}\"><a href=\"{{url}}\" class=\"item download\" data-download-id=\"{{id}}\"><dl class=\"description\" style=\"background-image: url(chrome://favicon/{{url}})\"><dt>{{{title}}} ({{size}} MB)</dt><dd class=\"time\">{{time}}</dd><dd class=\"location\">{{url}}</dd></dl></a> <a class=\"search_domain action\" href=\"#search/{{host}}\">{{i18n_search_by_domain}}</a> <a class=\"delete_download delete\" href=\"#\" data-url=\"{{url}}\" title=\"{{i18n_prompt_delete_button}}\">{{i18n_prompt_delete_button}}</a></li>{{/filename}} {{^filename}}<li class=\"visit\" data-url=\"{{url}}\" data-title=\"{{title}}\"><a href=\"{{url}}\" class=\"item site\"><dl class=\"description\" style=\"background-image: url(chrome://favicon/{{url}})\"><dt><div class=\"active_tags\"></div>{{{title}}}</dt><dd class=\"time\">{{time}}</dd><dd class=\"location\">{{url}}</dd></dl></a> <a class=\"search_domain action\" href=\"#search/{{host}}\">{{i18n_search_by_domain}}</a> <a class=\"delete_visit delete\" href=\"#\" data-url=\"{{url}}\" title=\"{{i18n_prompt_delete_button}}\">{{i18n_prompt_delete_button}}</a></li>{{/filename}} {{/visits}}</ol></div>{{/visitsByHour}}</div>{{/history}} {{^history}}<p>{{i18n_no_visits_found}}</p>{{/history}}';
(function() {
